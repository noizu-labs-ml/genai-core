...
defimpl GenAI.Legacy.NodeProtocol, for: [GenAI.Message, GenAI.Message.ToolUsage, GenAI.Message.ToolResponse] do
  def apply(node, thread_context)
  def apply(node, thread_context) do
...
defimpl GenAI.Legacy.NodeProtocol, for: GenAI.Graph do
  def apply(this, thread_context) do
    Enum.reduce(this.nodes, {:ok, thread_context},
      fn
        _, thread_context = {:error, _} -> thread_context
